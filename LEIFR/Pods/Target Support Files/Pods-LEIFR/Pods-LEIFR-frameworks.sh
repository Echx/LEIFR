...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Realm-iOS10.2/Realm.framework"
  install_framework "$BUILT_PRODUCTS_DIR/RealmSwift-iOS10.2/RealmSwift.framework"
  install_framework "$BUILT_PRODUCTS_DIR/UICircularProgressRing/UICircularProgressRing.framework"
  install_framework "$BUILT_PRODUCTS_DIR/wkb-ios-iOS10.2/wkb_ios.framework"
fi
